-- Add city and gender filters to the Likes You pool and count,
-- matching the full set of preference filters used in get_discover_pool.
...
language sql security definer stable as $$
  ...
  where
    ...
    -- viewer's interested_gender must include liker's gender (empty = open to all)
    and (
